...
# models
def generate_all(model_dir, dataset_dir, save_dir):
    ...
    for idx in trange(len(list_patient)):
        ...
        generate_act_maps_for_patient(model_dir, dataset_dir, i_patient, save_dir_patient)
    return 0


def generate_act_maps_for_patient(model_dir, dataset_dir, patient, save_dir):
    ...
    for idx in trange(len(list_model)):
        ...
        generate_act_maps_for_model(model, dataset_dir, patient, save_dir_model)

    return 0

def generate_act_maps_for_model(model, dataset_dir, patient, save_dir):
...
def main():
    ...
    save_dir = 'actmap' #'/playpen-ssd/jyn/infovis/act_map/'

    generate_all(model_dir, dataset_dir, save_dir)
